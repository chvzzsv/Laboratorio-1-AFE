...
<aside class="main-sidebar sidebar-dark-warning elevation-4" style="z-index: 1040 !important;">
    ...
    <img src="<?= Yii::$app->request->baseUrl ?>/logo-mini.png" alt="Logo" class="brand-image-xl logo-xs">
<img src="<?= Yii::$app->request->baseUrl ?>/logo.png" alt="Logo" class="brand-image-xs logo-xl" style="left: 12px">
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column nav-compact nav-flat" data-widget="treeview" role="menu" data-accordion="false">
                ...
                ?>
                <li class="<?= $li ?>"><a class="<?= $a ?>" href="<?php "#" ?>"><i class="nav-icon fas fa-tachometer-alt"></i>
                    ...
                    <?php if (Yii::$app->controller->id == 'tasks' && in_array(\Yii::$app->controller->action->id, ['index','view','create','update'])) {
                        ...
                        ?>
                        <li class="<?= $li; ?>"><a class="<?= $a; ?>" href="<?php echo Url::toRoute(['/tasks/index']); ?>"><i class="nav-icon far fa-circle text-blue"></i>
                                <p>Tareas</p>
                            </a></li>
                        <!-------------------------------------------------->
                         <!----------------Calculadora---------------------------------->
